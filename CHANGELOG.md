...
## [2.1.1](https://github.com/timvw/bose_soundtouch/compare/v2.1.0...v2.1.1) - 2025-02-25

### Fixed

- *(deps)* update rust crate reqwest to 0.12 (#111)
- *(deps)* update rust crate url to v2.5.4 (#110)
- *(deps)* update rust crate log to v0.4.26 (#108)
- *(deps)* update rust crate futures-util to v0.3.31 (#107)

### Other

- *(deps)* update rust crate clap to v4.5.31 (#109)
