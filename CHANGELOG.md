...
## [2.1.3](https://github.com/timvw/bose_soundtouch/compare/v2.1.2...v2.1.3) - 2026-09-25

### Fixed

- *(deps)* update rust crate quick-xml to 0.42 ([#262](https://github.com/timvw/bose_soundtouch/pull/262))
- *(deps)* update rust crate tokio-tungstenite to 0.30 ([#248](https://github.com/timvw/bose_soundtouch/pull/248))
- *(deps)* update rust crate quick-xml to 0.41 ([#245](https://github.com/timvw/bose_soundtouch/pull/245))
- *(deps)* update rust crate quick-xml to 0.40 ([#232](https://github.com/timvw/bose_soundtouch/pull/232))
- *(deps)* update rust crate tokio-tungstenite to 0.29
- *(deps)* update rust crate quick-xml to 0.39 ([#198](https://github.com/timvw/bose_soundtouch/pull/198))
- *(deps)* update rust crate reqwest to 0.13

### Other

- *(deps)* update rust crate tokio-test to v0.4.6 ([#266](https://github.com/timvw/bose_soundtouch/pull/266))
- *(deps)* update rust crate thiserror to v2.0.21 ([#265](https://github.com/timvw/bose_soundtouch/pull/265))
- *(deps)* update rust crate reqwest to v0.13.5 ([#264](https://github.com/timvw/bose_soundtouch/pull/264))
- *(deps)* update dependency rust to v1.98.1 ([#263](https://github.com/timvw/bose_soundtouch/pull/263))
- *(deps)* update rust crate log to v0.4.34 ([#261](https://github.com/timvw/bose_soundtouch/pull/261))
- *(deps)* update dependency rust to v1.98.0 ([#260](https://github.com/timvw/bose_soundtouch/pull/260))
- *(deps)* update rust crate futures-util to v0.3.34 ([#259](https://github.com/timvw/bose_soundtouch/pull/259))
- *(deps)* update rust crate thiserror to v2.0.20 ([#258](https://github.com/timvw/bose_soundtouch/pull/258))
- *(deps)* update rust crate tokio to v1.53.1 ([#257](https://github.com/timvw/bose_soundtouch/pull/257))
- *(deps)* update rust crate clap to v4.6.3 ([#256](https://github.com/timvw/bose_soundtouch/pull/256))
- *(deps)* update rust crate thiserror to v2.0.19 ([#255](https://github.com/timvw/bose_soundtouch/pull/255))
- *(deps)* update rust crate serde to v1.0.229 ([#254](https://github.com/timvw/bose_soundtouch/pull/254))
- *(deps)* update rust crate anyhow to v1.0.104 ([#253](https://github.com/timvw/bose_soundtouch/pull/253))
- *(deps)* update rust crate futures-util to v0.3.33 ([#252](https://github.com/timvw/bose_soundtouch/pull/252))
- *(deps)* update rust crate tokio to v1.53.0 ([#251](https://github.com/timvw/bose_soundtouch/pull/251))
- *(deps)* update dependency rust to v1.97.1 ([#250](https://github.com/timvw/bose_soundtouch/pull/250))
- *(deps)* update rust crate clap to v4.6.2 ([#249](https://github.com/timvw/bose_soundtouch/pull/249))
- *(deps)* update dependency rust to v1.97.0 ([#247](https://github.com/timvw/bose_soundtouch/pull/247))
- *(deps)* update actions/checkout action to v7
- *(deps)* update dependency rust to v1.96.1 ([#246](https://github.com/timvw/bose_soundtouch/pull/246))
- *(deps)* update rust crate anyhow to v1.0.103 ([#244](https://github.com/timvw/bose_soundtouch/pull/244))
- *(deps)* update rust crate log to v0.4.33 ([#243](https://github.com/timvw/bose_soundtouch/pull/243))
- *(deps)* update rust crate ratatui to v0.30.2 ([#242](https://github.com/timvw/bose_soundtouch/pull/242))
- *(deps)* update rust crate imageproc to 0.27 ([#237](https://github.com/timvw/bose_soundtouch/pull/237))
- *(deps)* update dependency rust to v1.96.0 ([#240](https://github.com/timvw/bose_soundtouch/pull/240))
- *(deps)* update rust crate ratatui to v0.30.1 ([#239](https://github.com/timvw/bose_soundtouch/pull/239))
- *(deps)* update rust crate log to v0.4.32 ([#238](https://github.com/timvw/bose_soundtouch/pull/238))
- *(deps)* update rust crate log to v0.4.31 ([#236](https://github.com/timvw/bose_soundtouch/pull/236))
- *(deps)* update rust crate reqwest to v0.13.4 ([#235](https://github.com/timvw/bose_soundtouch/pull/235))
- *(deps)* update rust crate log to v0.4.30 ([#234](https://github.com/timvw/bose_soundtouch/pull/234))
- *(deps)* update rust crate quick-xml to v0.40.1 ([#233](https://github.com/timvw/bose_soundtouch/pull/233))
- *(deps)* update rust crate quick-xml to v0.39.4 ([#231](https://github.com/timvw/bose_soundtouch/pull/231))
- *(deps)* update rust crate tokio to v1.52.3 ([#230](https://github.com/timvw/bose_soundtouch/pull/230))
- *(deps)* update rust crate quick-xml to v0.39.3 ([#229](https://github.com/timvw/bose_soundtouch/pull/229))
- *(deps)* update rust crate tokio to v1.52.2 ([#228](https://github.com/timvw/bose_soundtouch/pull/228))
- *(deps)* update rust crate imageproc to v0.26.2 ([#227](https://github.com/timvw/bose_soundtouch/pull/227))
- *(deps)* update rust crate reqwest to v0.13.3 ([#226](https://github.com/timvw/bose_soundtouch/pull/226))
- *(deps)* update rust crate tracing-appender to v0.2.5 ([#225](https://github.com/timvw/bose_soundtouch/pull/225))
- *(deps)* update rust crate tokio to v1.52.1 ([#224](https://github.com/timvw/bose_soundtouch/pull/224))
- *(deps)* update rust crate clap to v4.6.1 ([#223](https://github.com/timvw/bose_soundtouch/pull/223))
- *(deps)* update rust crate tokio to v1.52.0 ([#222](https://github.com/timvw/bose_soundtouch/pull/222))
...
- *(deps)* update rust crate clap to v4.6.0 ([#217](https://github.com/timvw/bose_soundtouch/pull/217))
- *(deps)* update rust crate image to v0.25.10
- *(deps)* update rust crate tokio to v1.50.0 ([#215](https://github.com/timvw/bose_soundtouch/pull/215))
- *(deps)* update rust crate imageproc to v0.26.1
- *(deps)* update rust crate quick-xml to v0.39.2 ([#213](https://github.com/timvw/bose_soundtouch/pull/213))
- *(deps)* update rust crate anyhow to v1.0.102
- *(deps)* update rust crate clap to v4.5.60 ([#211](https://github.com/timvw/bose_soundtouch/pull/211))
- *(deps)* update rust crate clap to v4.5.59
- *(deps)* update rust crate quick-xml to v0.39.1 ([#209](https://github.com/timvw/bose_soundtouch/pull/209))
- *(deps)* update rust crate futures-util to v0.3.32
- *(deps)* update rust crate clap to v4.5.58
- bump MSRV from 1.87 to 1.88
- *(deps)* update rust crate imageproc to 0.26 ([#196](https://github.com/timvw/bose_soundtouch/pull/196))
- *(deps)* update rust crate ratatui to 0.30.0
- bump MSRV to 1.87.0
- *(deps)* update rust crate reqwest to v0.13.2 ([#204](https://github.com/timvw/bose_soundtouch/pull/204))
- *(deps)* update rust crate anyhow to v1.0.101 ([#203](https://github.com/timvw/bose_soundtouch/pull/203))
- *(deps)* update rust crate clap to v4.5.57 ([#202](https://github.com/timvw/bose_soundtouch/pull/202))
- *(deps)* update rust crate clap to v4.5.56 ([#201](https://github.com/timvw/bose_soundtouch/pull/201))
- *(deps)* update rust crate clap to v4.5.55 ([#200](https://github.com/timvw/bose_soundtouch/pull/200))
- *(deps)* update rust crate thiserror to v2.0.18
- *(deps)* update rust crate url to v2.5.8 ([#197](https://github.com/timvw/bose_soundtouch/pull/197))
- *(deps)* update rust crate tokio-test to v0.4.5 ([#195](https://github.com/timvw/bose_soundtouch/pull/195))
- *(deps)* update rust crate tokio to v1.49.0 ([#194](https://github.com/timvw/bose_soundtouch/pull/194))
- *(deps)* update rust crate clap to v4.5.54 ([#193](https://github.com/timvw/bose_soundtouch/pull/193))
- *(deps)* update rust crate reqwest to v0.13.1 ([#192](https://github.com/timvw/bose_soundtouch/pull/192))
- *(deps)* update rust crate reqwest to v0.12.28 ([#189](https://github.com/timvw/bose_soundtouch/pull/189))
- *(deps)* update rust crate reqwest to v0.12.27
- *(deps)* update rust crate tracing to v0.1.44 ([#187](https://github.com/timvw/bose_soundtouch/pull/187))
- *(deps)* update rust crate reqwest to v0.12.26 ([#186](https://github.com/timvw/bose_soundtouch/pull/186))
...
- update dependencies
- Ensure Zone is (de)serialized as lower case "zone"
- update versions
